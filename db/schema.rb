...
ActiveRecord::Schema.define(version: 20160708010730) do
  ...
  add_index "palette_colours", ["color_id"], name: "index_palette_colours_on_color_id", using: :btree
  ...
  add_foreign_key "palette_colours", "colours", column: "color_id"
